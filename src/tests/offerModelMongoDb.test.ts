...
test("declineOffer should set the offer status to declined", async () => {
    const offer = await addOffer(validOffer);
...
test("declineOffer should throw DatabaseError for a non-existent offer id", async () => {
    await expect(declineOffer("00000000-0000-0000-0000-000000000000")).rejects.toThrow(DatabaseError);
});
