Error: Unexpected error during database initialization
 ❯ initialize src/models/userModelMongoDb.ts:60:19
     58|         } else {
     59|             logger.error("Unexpected error: " + String(err));
     60|             throw new Error("Unexpected error during database initialization");
       |                   ^
     61|         }
     62|     }
 ❯ src/tests/userModelMongoDb.test.ts:19:11
