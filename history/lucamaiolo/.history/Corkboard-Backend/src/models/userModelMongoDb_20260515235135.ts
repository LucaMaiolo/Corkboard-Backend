...
/**
 * Adds a new user to the database after validating input and hashing the password.
 * @param username username between 3-16 chars
 * @param password password min 8 chars
 * @param email valid email address
 * @param birthday valid date, user must be at least 18 years old
 * @returns created user object
 * @throws {InvalidInputError} if any input is invalid, username already exists, or email already in use
...
/**
 * Updates a users email,password and/or birthday
 * @param username username of user to update
 * @param updates all the things to be updated in one object
 * @returns the updated user object
 * @throws {InvalidInputError} if any provided field is invalid
...
/**
 * Verifies a username and plaintext password against the stored hashed password.
